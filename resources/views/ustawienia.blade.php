                        ...
                        <div class="card-body pt-1 pb-3">
                            ...
                            <form action="{{ route('user.destroy', Auth::user()->id) }}" method="post">
                                ...
                                <div class="col-6 col-lg-3">
                                    <button type="button" class="btn btn-custom-solid bg-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">Usuń konto</button>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <div class="row">
                                                    <div class="col mb-2">
                                                        <button type="submit" name="action" class="btn btn-custom-solid bg-danger" value="delete">Usuń</button>
                                                    </div>
                                                    <div class="col">
                                                        <button type="button" class="btn btn-custom-solid" data-bs-dismiss="modal">Anuluj</button>
                                                    </div>
                                                </div>
