                ...
                <form action="{{ url('/') }}" method="POST">
                    ...
                    <div class="row mt-md-3">
                        <div class="col-12 col-lg-5">
                            ...
                            <div class="input-group">
                                <input name="min_budget" type="number" min="100" step="100" value="{{ old('min_budget') }}1200" aria-label="First name" class="form-control @error('min_budget') is-invalid @enderror" >
                                <span class="input-group-text">zł</span>
                                <span class="filter-price mx-3">-</span>
                                <input name="max_budget" type="number" min="100" step="100" value="{{ old('max_budget') }}1300" aria-label="First name" class="form-control @error('max_budget') is-invalid @enderror" >
                                <span class="input-group-text ">zł</span>
                                @error('min_budget')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                      ...
                      <div class="modal-content">
                        <div class="modal-body mt-4 mb-4">
                            ...
                            <div class="d-flex justify-content-center align-items-center flex-column">
                                <span class="display-4"><b>{{ Session::get('flats_count') }}</b></span>
